...
#include <stdio.h>
#include <stdlib.h>
//stdlib was not included
#include <time.h>

/*-----------------------------------------------------------------------------
-                                Prototypes                                   -
------------------------------------------------------------------------------*/
//comment was not declared properly
char ask_to_play(int times_played);
void run_game(int computer_number);
//run game was not declared about the main function before it was called
...
-								Implementation								 -
-----------------------------------------------------------------------------*/
//comment is not ended correctly
...
char ask_to_play(int played_before)
{
    ...
    if (!played_before)    /* This line does not contain an error */
    {
        ...
        //scanf(" %c", yes_or_no);
		//missing & symbol in the function
		scanf(" %c", &yes_or_no);
    } else
    {
        scanf(" %c", &yes_or_no);
